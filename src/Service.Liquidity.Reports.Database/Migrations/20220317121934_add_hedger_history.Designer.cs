...
namespace Service.Liquidity.Reports.Database.Migrations
{
    ...
    [Migration("20220317121934_add_hedger_history")]
    partial class add_hedger_history
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Service.Liquidity.Reports.Domain.Models.HedgeOperationRecord", b =>
                {
            ...
            modelBuilder.Entity("Service.Liquidity.Reports.Domain.Models.HedgeTradeRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Service.Liquidity.Reports.Domain.Models.HedgeTradeRecord", b =>
                {
                    b.HasOne("Service.Liquidity.Reports.Domain.Models.HedgeOperationRecord", "HedgeOperation")
                        .WithMany("HedgeTrades")
                        .HasForeignKey("HedgeOperationId");

                    b.Navigation("HedgeOperation");
                });

...
namespace Service.Liquidity.Reports.Database.Migrations
{
    ...
    [Migration("20220519130503_AddWithdrawalHistoryDb")]
    partial class AddWithdrawalHistoryDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Service.Liquidity.Reports.Domain.Models.Models.Withdrawal", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("ExchangeAsset")
                        .HasColumnType("text");
                    ...
                    b.HasIndex(new[] { "Exchange", "TxId" }, "ExchangeTxId")
                        .IsUnique();

                    b.ToTable("exchangewithdrawalshistory", "lp_reports");
                });
